...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Complted (3) Modify the Adapter to take a PlaceBuffer in the constructor
    ...
    private void refreshPlacesData() {
        ...
        PendingResult<PlaceBuffer> placeResult
                = Places.GeoDataApi.getPlaceById(mClient,
    ...
    //COmplted (2) call refreshPlacesData in GoogleApiClient's onConnected and in the Add New Place button click event
